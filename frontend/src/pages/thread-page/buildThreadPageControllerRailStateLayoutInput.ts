...
export function buildThreadPageControllerRailStateLayoutInput({
  ...
  const totalMessageCount =
    dataState.threadProjection?.messageCount ??
  ...
  return {
    ...
    currentThreadStatus: dataState.threadProjection?.status ?? dataState.selectedThread?.status,
    ...
    latestTurnStatus:
      ...
      dataState.threadProjection?.status ??
    ...
    liveThreadCwd: dataState.threadProjection?.cwd,
