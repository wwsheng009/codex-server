...
describe('ThreadWorkbenchSurface', () => {
  ...
  it('renders realtime degraded recovery guidance above the thread timeline', () => {
    const html = renderToStaticMarkup(
      <ThreadWorkbenchSurface
        activeSurfacePanelSide="right"
        approvalAnswers={{}}
        ...
        workspaceStreamRecoveryNotice={{
          details: 'Workspace ID: ws-1\nLatest lifecycle event: seq-gap-detected',
          latestEventKind: 'seq-gap-detected',
          latestEventTs: '2026-03-28T10:00:00.000Z',
          message:
          ...
          noticeKey: 'workspace-stream-ws-1-event-recovery-seq-gap',
          reason: 'event-recovery',
          title: 'Realtime sync is recovering',
          tone: 'error',
        }}
      >
        <div>composer-probe</div>
    ...
    expect(html).toContain('Realtime sync is recovering')
    expect(html).toContain('Some live events arrived out of order or were dropped.')
