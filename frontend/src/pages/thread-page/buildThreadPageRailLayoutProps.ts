...
export function buildThreadPageRailLayoutProps(
  ...
  const railProps: RailProps = {
    ...
    currentOutputTokens: input.currentOutputTokens,
    currentReasoningTokens: input.currentReasoningTokens,
    ...
    isTerminalDockVisible: input.isTerminalDockVisible,
    ...
    onShowTerminalDock: input.onShowTerminalDock,
