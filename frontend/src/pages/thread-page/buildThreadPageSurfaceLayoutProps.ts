...
export function buildThreadPageSurfaceLayoutProps(
  ...
  const surfaceProps: SurfaceProps = {
    ...
    onRetryRuntimeOperation: input.onRetryRuntimeOperation,
    onRestartAndRetry: input.onRestartAndRetry,
    ...
    hasRecoverableRuntimeOperation: input.hasRecoverableRuntimeOperation,
    runtimeRecoveryExecutionNotice: input.runtimeRecoveryExecutionNotice,
    runtimeRecoveryNotice: input.runtimeRecoveryNotice,
    restartAndRetryPending: input.restartAndRetryPending,
